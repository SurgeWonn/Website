...
<head>
	...
	<link rel="stylesheet" href="/Website/css/bootstrap-theme.css">
	<link href='https://unpkg.com/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
</head>
<body class="font-mali fs-20">
	<section class="bg-light min-vh-100">
		<nav class="navbar navbar-expand-sm navbar-dark bg-success"> 
			<a class="navbar-brand" href="#">Rangsarit</a>
		...
		<div class="container-fluid">
			<div class="row mt-3">
				<div class="col-sm-3 col-md-2">
					<div class="list-group">
						<a href="01_Home.php" class="list-group-item list-group-item-success">
							Home
						</a>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<div class="row mt-4">
										<div class="col-sm-4 ">
											<img src="/Website/img/a.png" class="w-100 rounded-circle">
										</div>
										<div class="col-sm mt-5 ">
											<h3 class="my-4 fs-50 font-mali text-center">ยินดีต้อนรับเข้าสู่เว็บไซต์</h3>
											<h3 class="my-4 fs-40 font-mali text-white bg-success text-center">นายรังสฤษฏ์ มากมี</h3> 
											<p  class="my-4 fs-30 font-mali text-center">ระดับชั้น ปวช.คพ.2.2 เลขที่ 20</p>
			...
			<div class="row mt-5 bg-success text-white p-3">
				<div class="col-sm-6">
					<h3>Bootstrap Sample</h3>
					<p>Copyright 2024</p>
				</div>
				<div class="col-sm-6">
					<h3>Designed by Rangsarit</h3>
